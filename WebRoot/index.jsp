<%@ page language="java" import="java.util.*,zy.com.entity.FileInfoBean"
	pageEncoding="UTF-8"%>
<%
			...
			<form action="UploadFiles" enctype="multipart/form-data"
				...
				<div style="float: right;">
					<div class="form-group mb-n col-sm-4">
						<input type="submit" class="btn btn-danger" value="提交/刷新"
							text-align:center;">
					</div>
				</div>
			</form>
				...
				<tbody>
					<c:forEach var="file" items="${filesList}">
						<tr>
							...
							<td>${file.fileSize}</td>
							<td>${file.fileDate}</td>
							<td><a href="DowFileByName?filename=${file.fileName}">下载</a></td>
							<td><a href="DelFileByName?filename=${file.fileName}">删除</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
